function init() {
Tabletop.init( { key: 'https://docs.google.com/spreadsheets/d/15sTos9WzSAqyQijF_0a2hFK36ADLOYkm2fKURS-O-q8/edit?usp=sharing',
...
for (var i = 0; i < data.length; i++) {
	...
	if (atomic.includes(data[i].office)) {		
			...
			'<td class="current_points">' + data[i].q2_star + '</td>' +
			'<td class="current_points">' + data[i].q3_star + '</td>' +
