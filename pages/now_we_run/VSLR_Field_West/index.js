function init() {
Tabletop.init( { key: 'https://docs.google.com/spreadsheets/d/1OQcg_QVKa6WdUWNAcfYqwOaEvY-QrOhMC_jSOTN5hlM/edit?usp=sharing',
...
for (var i = 0; i < data.length; i++) {
	...
	if (west_coast.includes(data[i].office)) {
			$("#table-body").append(
			'<tr class="row">' +
			'<td class="name-column small-text">' + data[i].name + '</td>' +
			'<td class="office-column small-text">' + data[i].office + '</td>' +
